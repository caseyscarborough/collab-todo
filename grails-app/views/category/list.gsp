			...
			<table>
				<thead>
					<tr>
						...
						<th><g:message code="category.user.label" default="User" /></th>
					
					</tr>
				</thead>
				<tbody>
				<g:each in="${categoryInstanceList}" status="i" var="categoryInstance">
					<g:if test="${categoryInstance.user.id == session.user.id}">
					<tr class="row">
						...
						<td>${fieldValue(bean: categoryInstance, field: "user")}</td>
					</tr>
					</g:if>
				</g:each>
				</tbody>
