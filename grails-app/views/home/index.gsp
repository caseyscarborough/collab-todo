...
<html>
	...
	<body>
			...
			<g:if test="${!session?.user}">
				<p><g:link controller="login">Login</g:link> to the application
				for greater functionality.</p>
				<p>If you don't have an account yet, you can <g:link controller="login" action="register">Register</g:link> for one.</p><br>
			</g:if>
